<nav class="fixed left-0 bg-[rgba(49,49,49,0.9)] dark:bg-[rgba(49,51,56,0.9)] h-screen p-4 flex flex-col justify-start items-center">
        <button class="lg:hidden text-white-text">
